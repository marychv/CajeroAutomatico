...
// Clase para retirar efectivo del monto que ya se tiene establecido para cada usuario
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    if (confirmacion == 0) {
                        if ((saldo - 5000) >= 0) {
                            JOptionPane.showMessageDialog(null, "El retiro de 5000 colones fue realizado con éxito", "Retiro de Efectivo",1);
                            return saldo - 5000;
                ...
                case 2:
                    ...
                    if (confirmacion1 == 0) {
                        if ((saldo - 10000) >= 0) {
                            JOptionPane.showMessageDialog(null, "El retiro de 10000 colones fue realizado con éxito", "Retiro de Efectivo",1);
                            return saldo - 10000;
                ...
                case 3:
                    ...
                    if (confirmacion2 == 0) {
                        if ((saldo - 20000) >= 0) {
                            JOptionPane.showMessageDialog(null, "El retiro de 20000 colones fue realizado con éxito", "Retiro de Efectivo",1);
                            return saldo - 20000;
                ...
                case 4:
                    ...
                    if (confirmacion3 == 0) {
                        if ((saldo - montoRetirar) >= 0) {
                            JOptionPane.showMessageDialog(null, "El retiro del monto de " + montoRetirar + " colones fue realizado con éxito", "Retiro de Efectivo",1);
